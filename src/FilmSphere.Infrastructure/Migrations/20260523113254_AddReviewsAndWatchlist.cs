...
{
    /// <inheritdoc />
    public partial class AddReviewsAndWatchlist : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_watchlist_items_films_film_id",
                        column: x => x.film_id,
                        principalTable: "films",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_watchlist_items_film_id",
                table: "watchlist_items",
                column: "film_id");

            migrationBuilder.CreateIndex(
                name: "ix_watchlist_items_user_id_film_id",
                table: "watchlist_items",
